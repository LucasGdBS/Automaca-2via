...
class Bot:
	...
	def find_contract(self):
		try:
			...
			print(f"Erro ao encontrar contrato: {e}")
			self.driver.quit()
			raise
	...
	def access_pdf(self):
		try:
			...
			img_element = self.wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, "img.tipViaPgto")))
			img_element.click()
